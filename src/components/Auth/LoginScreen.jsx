...
export function LoginScreen({ onSwitchToSignup, onContinueAsGuest }) {
  ...
  async function handleSubmit(e) {
    ...
    // No need to handle success - auth state change will handle navigation
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Sign in to your soccer tracker account</p>
        </div>
